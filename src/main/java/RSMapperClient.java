...
public class RSMapperClient extends JApplet implements Serializable, ActionListener, ComponentListener {
   ...
   public static int PORT_ID = 43597;
            ...
            public void windowClosing(WindowEvent we) {
               ...
               if (unsavedCount > 0) {
                  ...
                  String message = String.format(
                     ...
                     (unsaved[0] || unsaved[1] || unsaved[2]) && unsaved[3] ? ", underland" : (unsaved[3] ? "underland" : "")
                  );
   ...
   public void componentResized(ComponentEvent arg0) {
      try {
         ...
         UIPanels.propertiesTabPanel.setSize(new Dimension(300, UIPanels.propertiesTabPanel.getPreferredSize().height + addedHeight));
         UIPanels.objectsTabPanel.setSize(new Dimension(300, UIPanels.objectsTabPanel.getPreferredSize().height + addedHeight));
         if (UIPanels.bottomPanel != null) {
            if (((BottomMenu)UIPanels.bottomPanel).noteScrollPane != null) {
               ((BottomMenu)UIPanels.bottomPanel)
                  .noteScrollPane
                  .setSize(
                     new Dimension(
                        ((BottomMenu)UIPanels.bottomPanel).noteScrollPane.getPreferredSize().width + addedWidth,
               ...
               ((BottomMenu)UIPanels.bottomPanel)
                  ...
                  .setSize(
                     new Dimension(
                        ((BottomMenu)UIPanels.bottomPanel).selectedNoteTitle.getPreferredSize().width + addedWidth,
               ...
               saveNoteButton.setSize(new Dimension(saveNoteButton.getPreferredSize().width + addedWidth, saveNoteButton.getPreferredSize().height));
               JButton deleteNoteButton = (JButton)UIPanels.generalComponents.get("delete_note");
               deleteNoteButton.setBounds(506 + addedWidth, deleteNoteButton.getY(), deleteNoteButton.getWidth(), deleteNoteButton.getHeight());
            }
            ...
            ((BottomMenu)UIPanels.bottomPanel)
               .overlaysPanel
               .setPreferredSize(new Dimension(newWidth, 3 + (255 / (9 + textureButtonShift) + (255 % (9 + textureButtonShift) > 0 ? 1 : 0)) * 68));
            ((BottomMenu)UIPanels.bottomPanel)
               .underlaysPanel
               .setPreferredSize(new Dimension(newWidth, 3 + (166 / (9 + textureButtonShift) + (166 % (9 + textureButtonShift) > 0 ? 1 : 0)) * 68));
         }
